...
import type { Member as _Member, MemberStatus as _MemberStatus, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addPayment(arg0: bigint, arg1: number, arg2: string, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addPayment(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async checkIn(arg0: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async createMember(arg0: string, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createMember(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCheckInsForMember(arg0: bigint): Promise<Array<CheckIn>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCheckInsForMember(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMember(arg0: bigint): Promise<Member> {
        if (this.processError) {
            try {
                const result = await this.actor.getMember(arg0);
                return from_candid_Member_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getPaymentsForMember(arg0: bigint): Promise<Array<Payment>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPaymentsForMember(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async linkPrincipalToMember(arg0: Principal, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.linkPrincipalToMember(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMember(arg0: bigint, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMember(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        planId: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.planId)),
        name: value.name,
        createdAt: value.createdAt,
        membershipStart: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.membershipStart)),
        updatedAt: value.updatedAt,
        membershipEnd: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.membershipEnd))
    };
}
